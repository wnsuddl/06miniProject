...
%> --%>
<!-- 
이 예민한 아이는 우리가 GetProductAction에서 request.setAttribute("vo", vo);라고 해주었기 때문에
getAttribute("ProductVO")라고 하면 에러가 난다. getAttribute("vo")라고 써줘야 한다. 
어찌보면 request에 "vo"로 set해줬으니 "vo"로 get하는건 당연한 것 같기도 하다. 어리석었다. 
-->
